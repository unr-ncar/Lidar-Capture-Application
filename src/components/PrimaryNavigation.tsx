...
export default function PrimaryNavigation() {
    return (
        <nav className="border-t-2 flex flex-row gap-1 bg-white justify-around py-2 lg:border-t-0 lg:border-r-2 lg:flex-col lg:justify-start lg:px-4 lg:pt-6 lg:gap-6">
